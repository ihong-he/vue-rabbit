...
const loginRules = ref({
  ...
  password: [
    ...
    { min: 6, max: 14, message: '请输入6-14位字符', trigger: 'blur' }
  ],
  agree: [{
    // 自定义校验规则
    ...
    <section class="login-section">
      <div class="wrapper">
        ...
        <div class="account-box">
          <div class="form">
            <el-form :model="loginForm" ref="formRef" :rules="loginRules" label-position="right" label-width="60px"
              status-icon>
              ...
              <el-button size="large" class="subBtn" @click="sumbit">点击登录</el-button>
            </el-form>
          </div>
        </div>
      </div>
